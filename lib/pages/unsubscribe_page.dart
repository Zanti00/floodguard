...
class _UnsubscribePageState extends State<UnsubscribePage> {
  ...
  Future<void> _unsubscribe() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Successfully unsubscribed from notifications'),
          backgroundColor: Colors.green,
          duration: Duration(seconds: 2),
        ),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(_cleanErrorMessage(_error!)),
          backgroundColor: Colors.red,
          duration: Duration(seconds: 3),
        ),
      );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              Text(
                'Enter your phone number to stop receiving flood alerts',
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'You will no longer receive flood alert notifications after unsubscribing.',
                              style: TextStyle(
                                color: Colors.orange.shade700,
                                fontSize: 12,
                              ),
                    ...
                    TextField(
                      ...
                      enabled: !_isLoading && !_unsubscribed,
                      decoration: InputDecoration(
